...
import TotalIncome from '../TotalIncome/TotalIncome'; // Import TotalIncome component
...
function App() {
  ...
  return (
    <main>
      <Header />
      <TotalIncome selectedBand={selectedBand} bandsData={bandsData.bands} /> {/* Render TotalIncome component */}
      ...
      <IncomeByMusician selectedBand={selectedBand} bandsData={bandsData.bands} /> {/* Pass selectedBand to IncomeByMusician */}
